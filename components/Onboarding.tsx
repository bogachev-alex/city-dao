...
export default function Onboarding() {
  ...
  const STEPS: Step[] = [
    { title: t('step0Title'), text: t('step0Text'), mood: 'waving', icon: '👋', target: 'logo', position: 'bottom' },
    { title: t('step1Title'), text: t('step1Text'), mood: 'happy', icon: '🗺️', target: 'map', position: 'bottom' },
    { title: t('step2Title'), text: t('step2Text'), mood: 'thinking', icon: '📋', target: 'contracts', position: 'bottom' },
    { title: t('step3Title'), text: t('step3Text'), mood: 'surprised', icon: '💰', target: 'crowdfunding', position: 'bottom' },
    { title: t('step4Title'), text: t('step4Text'), mood: 'thinking', icon: '🏛️', target: 'treasury', position: 'bottom' },
    { title: t('step5Title'), text: t('step5Text'), mood: 'happy', icon: '🏗️', target: 'admin', position: 'bottom' },
    { title: t('step6Title'), text: t('step6Text'), mood: 'waving', icon: '🛡️', target: 'auth', position: 'bottom-left' },
  ]
