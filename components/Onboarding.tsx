...
const STEPS: Step[] = [
  {
    ...
    text: 'Добро пожаловать в Amanat Protocol! Это платформа, где жители Алматы могут видеть, куда уходят бюджетные деньги на строительство — и влиять на это. Давай покажу, что тут есть.',
    mood: 'waving',
    icon: '👋',
    target: 'logo',
    position: 'bottom',
