  ...
  return (
    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-6">
      ...
      <div className="bg-gray-50 dark:bg-gray-950 rounded-lg p-4 mb-4 border border-gray-200 dark:border-gray-800">
        <div className="text-xs text-gray-500 dark:text-gray-400 mb-2">Формула расчёта штрафа:</div>
        <div className="text-sm text-gray-700 dark:text-gray-300 font-mono">
          <span className="text-yellow-600 dark:text-yellow-400">дни_просрочки</span>
          <span className="text-gray-400 dark:text-gray-500"> × </span>
          <span className="text-blue-500 dark:text-blue-400">1%</span>
          <span className="text-gray-400 dark:text-gray-500"> × </span>
          <span className="text-emerald-500 dark:text-emerald-400">сумма_контракта</span>
          <span className="text-gray-400 dark:text-gray-500"> = </span>
          <span className="text-red-500 dark:text-red-400">штраф</span>
        </div>
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <div className="bg-gray-50 dark:bg-gray-950 rounded-lg p-3 border border-gray-200 dark:border-gray-800">
          <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">Эскроу (20%)</div>
          <div className="text-gray-900 dark:text-white font-semibold">{formatAmount(contract.escrow_amount)}</div>
          <div className="text-xs text-gray-400 dark:text-gray-500">USDC заморожено</div>
        </div>
        <div className="bg-gray-50 dark:bg-gray-950 rounded-lg p-3 border border-gray-200 dark:border-gray-800">
          <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">Штраф в день</div>
          <div className="text-yellow-600 dark:text-yellow-400 font-semibold">{formatAmount(dailyPenalty)}</div>
          <div className="text-xs text-gray-400 dark:text-gray-500">USDC / день</div>
        </div>
      </div>
      ...
      {contract.penalty_amount > 0 || isOverdue ? (
        <>
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-gray-500 dark:text-gray-400">Текущий штраф</span>
          ...
          <div className="space-y-1">
            ...
            <div className="flex justify-between text-xs">
              <span className="text-gray-400 dark:text-gray-500">Осталось: {formatAmount(Math.max(0, Math.round(contract.escrow_amount - currentPenalty)))} USDC</span>
