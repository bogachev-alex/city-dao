  ...
  if (step === 'done') {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Регистрация завершена!</h3>
        <p className="text-gray-500 dark:text-gray-400 mb-6">Вы зарегистрированы как гражданин Amanat Protocol</p>
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-5 text-left mb-6 max-w-sm mx-auto">
          <div className="space-y-3">
            ...
            <div>
              <div className="text-xs text-gray-400 dark:text-gray-500 mb-1">IIN хэш (SHA-256)</div>
              <div className="font-mono text-xs text-emerald-600 dark:text-emerald-400 break-all">{iinHash}</div>
            </div>
            <div>
              <div className="text-xs text-gray-400 dark:text-gray-500 mb-1">Кошелёк</div>
            ...
            <div>
              ...
              {onChain ? (
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-yellow-600 dark:text-yellow-400 text-xs">Ожидает подтверждения</span>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="flex gap-3 justify-center">
          ...
          <a href="/contracts" className="px-5 py-2.5 rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 font-medium hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">
            Контракты
          </a>
        </div>
      </div>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-gray-900 dark:text-white font-semibold">Введите ИИН</h3>
        </div>

        <div className="space-y-3">
          <div>
            <label className="text-sm text-gray-500 dark:text-gray-400 mb-2 block">ИИН (12 цифр)</label>
            <input
              type="text"
              maxLength={12}
              value={iin}
            ...
            <div className="flex items-center justify-between mt-1.5">
              <span className="text-xs text-gray-400 dark:text-gray-500">{iin.length}/12 символов</span>
              {isValidIIN && <span className="text-xs text-emerald-500 dark:text-emerald-400">Действительный ИИН</span>}
            </div>
          </div>
      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-gray-900 dark:text-white font-semibold">Выберите район</h3>
        </div>
      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-gray-900 dark:text-white font-semibold">Подключить кошелёк</h3>
        </div>
        {!connected ? (
          ...
          <div className="flex items-center gap-3 bg-emerald-50 dark:bg-emerald-500/20 border border-emerald-200 dark:border-emerald-500/30 rounded-xl p-4">
            ...
            <div>
              <div className="text-emerald-600 dark:text-emerald-400 font-medium text-sm">Подключено</div>
      ...
      <div className="bg-blue-50 dark:bg-blue-500/20 border border-blue-200 dark:border-blue-500/30 rounded-xl p-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <div className="text-blue-600 dark:text-blue-400 font-medium text-sm mb-1">Конфиденциальность</div>
