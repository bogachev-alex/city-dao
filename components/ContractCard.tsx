...
export default function ContractCard({ contract }: ContractCardProps) {
  ...
  return (
    <Link href={`/contracts/${contract.id}`}>
      <div className="group bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-5 hover:border-emerald-300 dark:hover:border-emerald-500/40 hover:shadow-md dark:hover:shadow-lg transition-all duration-200 cursor-pointer">
        {/* Header */}
        ...
        <div className="flex items-center justify-between mb-3">
          <div>
            <div className="text-xs text-gray-400 dark:text-gray-500 mb-0.5">Сумма контракта</div>
            <div className="text-gray-900 dark:text-white font-semibold">{formatAmount(contract.amount_usdc)} USDC</div>
          </div>
          <div className="text-right">
            <div className="text-xs text-gray-400 dark:text-gray-500 mb-0.5">Дедлайн</div>
