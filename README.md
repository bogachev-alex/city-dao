...
<h1 align="center"><a href="https://74-208-191-110.nip.io:4443/" target"_blank">Straita</a></h1>
...
Straita переносит государственные контракты на блокчейн Solana. **20% суммы контракта** замораживается в смарт-контракте (escrow). Штрафы начисляются автоматически. Граждане проверяют качество работ через **случайное жюри**, а расходы районной казны одобряются голосованием с **AI-аналитикой**.
