...
<h1 align="center">Amanat Protocol</h1>
...
```mermaid
pie title Модели субсидирования
    "Государство (детские площадки, школы)" : 90
    "Граждане" : 10
```
...
flowchart LR
    ...
    B -->|"Хеш"| C["Блокчейн"]
    A -.->|"Никогда не покидает<br/>браузер"| X["Сервер / API / Логи"]

    style A fill:#ef4444,color:#fff
    style B fill:#f59e0b,color:#fff
    style C fill:#10b981,color:#fff
    style X fill:#9ca3af,color:#fff,stroke-dasharray: 5 5
```
...
Разработано командой **Amanat Protocol** (Алматы, Казахстан) для хакатона Solana.
