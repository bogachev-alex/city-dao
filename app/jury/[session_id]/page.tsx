    ...
    <div className="min-h-screen pt-16 bg-gray-50">
      ...
      <div className="border-b border-gray-200 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-3 flex items-center gap-3">
          ...
          <span className="text-gray-500 text-sm">Голосование жюри</span>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Голосование присяжного</h1>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4">
            <div className="grid grid-cols-3 gap-4 text-sm">
              <div>
                <div className="text-gray-400 text-xs mb-1">Метод голосования</div>
                <div className="text-gray-900 font-medium">Commit-Reveal</div>
              </div>
              <div>
                <div className="text-gray-400 text-xs mb-1">Присяжных</div>
                <div className="text-gray-900 font-medium">{sessionInfo?.votes?.length || '...'}</div>
              </div>
              <div>
                <div className="text-gray-400 text-xs mb-1">Статус</div>
                <div className={`font-medium ${
                  sessionInfo?.status === 'FINALIZED' ? 'text-emerald-600' :
                  sessionInfo?.status === 'ESCALATED' ? 'text-yellow-600' :
                  'text-blue-600'
                }`}>
        ...
        <div className="mt-8 bg-white border border-gray-200 rounded-xl p-5">
          <h3 className="text-gray-500 text-sm font-medium mb-3">Как работает commit-reveal?</h3>
          <div className="space-y-2 text-xs text-gray-500">
            <div className="flex gap-2">
              <span className="text-emerald-500 font-bold shrink-0">1.</span>
              <span>Вы голосуете (Accept/Reject), и ваш голос шифруется: <code className="text-emerald-600 bg-emerald-50 px-1 rounded">SHA-256(голос + соль)</code>. Хэш сохраняется в БД.</span>
            </div>
            <div className="flex gap-2">
            ...
            <div className="flex gap-2">
              ...
              <span>Смарт-контракт проверяет: <code className="text-emerald-600 bg-emerald-50 px-1 rounded">SHA-256(голос + соль) == хэш</code>. Если совпадает — голос засчитан.</span>
            </div>
            <div className="flex gap-2">
